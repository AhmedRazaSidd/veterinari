                ...
                <header>
                    <nav className="navbar navbar-expand-lg">
                        <div className="container-fluid">
                            ...
                            <button className="btn border-0 px-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
